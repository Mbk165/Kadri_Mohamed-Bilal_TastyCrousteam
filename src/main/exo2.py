...
from agents.team7.agent7 import Agent7 # On importe que Agent7
from pystk2_gymnasium.envs import STKRaceMultiEnv, AgentSpec
from pystk2_gymnasium.definitions import CameraMode

MAX_TEAMS = 1 # 1 team max (Agent7)
MAX_STEPS = 1000 # On baisse le pas de temps a 200
NB_RACES = 1
...
def create_race():
    ...
    agents.append(Agent7(env, path_lookahead=3)) #On ne laisse que Agent7
